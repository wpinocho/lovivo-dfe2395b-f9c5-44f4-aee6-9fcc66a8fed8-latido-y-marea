        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img 
                src="https://ptgmltivisbtvmoxwnhd.supabase.co/storage/v1/object/public/message-images/8fd9d699-54b2-4e17-ace8-1d402755d17f/1769109012352-nipni6ooko.png"
                alt="Latido y Marea"
                className="h-16 w-16 object-contain"
              />
              <span className="text-xl font-display text-white">Latido y Marea</span>
            </div>
